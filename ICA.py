...
scatter = ax_main.scatter(X_ica[labels == 0, 0], X_ica[labels == 0, 2], c='red', alpha=0.8, label=data_types[0])
scatter = ax_main.scatter(X_ica[labels == 1, 0], X_ica[labels == 1, 2], c='blue', alpha=0.8, label=data_types[1])
