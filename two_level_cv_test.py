...
# Data set:
data_set = "fNirs_motor_full_data" # "fNIRS_Alexandros_Healthy_data" #"fNirs_motor_full_data"
epoch_type = "Tapping" #"Imagery"
...
SVM.theta = {"kernel": ["rbf"], "C": list(np.logspace(-2, 10, 13)), "gamma": list(np.logspace(-9, 3, 13)), "degree": [1], "coef0": [0]}
# Mean.theta = {}
# Baseline.theta = {}
# PosNeg.theta = {}
...
ANN_AND_SVM = ANN.theta.get("use_svm")
